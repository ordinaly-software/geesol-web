...
export const ServiceTemplate = ({
  ...
  subtitle,
  badge,
  heroImage = "/static/main_home_ilustration.webp",
  highlights,
  features,
  steps,
  galleryTitle,
    ...
    <div className="bg-[#f7f8fb] text-[#0c1f2d] dark:bg-[#0b1220] dark:text-gray-100">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-6 px-4 pb-16 pt-28 text-center md:pb-24 md:pt-32">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button asChild className="px-8 py-3 text-lg uppercase">
              <Link href={contactHref}>Solicitar estudio</Link>
            </Button>
            <Button asChild variant="outline" className="bg-white/15 px-8 py-3 text-lg text-white">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-black text-[#0c3b52] dark:text-white">
                Diseñado para maximizar tu ahorro
              </h2>
              <p className="text-gray-700 dark:text-gray-300">
                Seleccionamos componentes de primera, optimizamos la orientación y nos ocupamos de toda la tramitación para que tu instalación rinda al máximo desde el primer día.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl space-y-10">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Un proceso claro, transparente y rápido para que disfrutes de tu instalación sin complicaciones.
            </p>
          </div>
      ...
      {galleryImages.length > 0 && (
        <section className="bg-white px-4 py-16 dark:bg-[#0b1220]">
          <div className="mx-auto max-w-6xl space-y-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-[#0c3b52] dark:text-white">
                {galleryTitle || "Galería de instalaciones"}
              </h3>
              {galleryDescription && (
      ...
      <section className="bg-[#0c3b52] px-4 py-16 text-white dark:bg-[#060a14]">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 text-center">
          <h3 className="text-3xl font-black">Solicita tu estudio personalizado</h3>
          <p className="max-w-2xl text-lg text-[#e9eef2]">
            Calculamos tu producción, las subvenciones disponibles y diseñamos una propuesta a medida con las mejores condiciones.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button asChild className="px-8 py-3 text-lg uppercase">
              <Link href={contactHref}>Contacto</Link>
            </Button>
            <Button asChild variant="outline" className="bg-white/10 px-8 py-3 text-lg text-white">
              <Link href={`${getBasePath(locale)}/nosotros`}>Conoce al equipo</Link>
            </Button>
          </div>
        </div>
      </section>
