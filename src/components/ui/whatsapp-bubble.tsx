    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={openModal}
            className="relative bg-gradient-to-br from-[#0f5f15] to-[#1F8A0D] text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-[1.08] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F8A0D] focus-visible:ring-offset-2 group"
