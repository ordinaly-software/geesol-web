...
export const HeroSection = () => {
  ...
  return (
    <HeroHighlight containerClassName="min-h-[78vh] bg-[#f7f8fb] dark:bg-[#0b1220]">
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-12 sm:gap-16 px-4 pt-4 sm:pt-20 pb-20 sm:pb-20 lg:flex-row lg:items-stretch lg:gap-12 lg:py-20">
        ...
        <div className="relative z-10 flex-1 order-1 lg:order-2">
          <div className="relative h-[280px] sm:h-[380px] lg:h-[520px] overflow-hidden rounded-[36px] bg-white shadow-[0_24px_70px_rgba(12,59,82,0.28)] dark:bg-[#0f172a]">
        ...
        <div className="relative z-10 flex-1 space-y-6 text-left order-2 lg:order-1">
          ...
          <div className="flex flex-col gap-10 sm:flex-row sm:items-center sm:gap-4 pt-6 sm:pt-0">
            <Button asChild className="w-full text-lg px-6 py-3 uppercase sm:w-auto sm:px-8">
              <Link href="#cta">{t("hero.cta")}</Link>
            </Button>
            <span className="hidden sm:flex text-sm font-semibold text-gray-600 dark:text-gray-300">
              {t("hero.subtext")}
            </span>
          </div>
        </div>
