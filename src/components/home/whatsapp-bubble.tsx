    ...
    <>
      ...
      >
        <div className="relative">
          {/* Pulse animation */}
          <div className="absolute inset-0 bg-[#D01B17] rounded-full animate-ping opacity-30"></div>
          
          <button
            onClick={openModal}
            className="relative bg-[#D01B17] hover:bg-[#D01B17] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 group"
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#23272F] text-gray-900 dark:text-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-gray-700 overflow-hidden">
            {/* Header */}
            <div className="bg-[#D01B17] text-white p-6 relative">
              <ModalCloseButton
                onClick={closeModal}
                variant="default"
                size="md"
            ...
            <div className="p-6">
              <div className="mb-6">
                <div className="bg-gradient-to-r from-[#D01B17]/10 to-[#D01B17]/10 dark:from-[#D01B17] dark:to-[#D01B17] p-4 rounded-lg border border-gray-200 dark:border-gray-700 mb-4">
                  <div className="flex items-start space-x-3">
                    <div className="bg-[#D01B17] rounded-full p-2 flex-shrink-0">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={idx} className="flex items-center space-x-2 text-sm text-gray-800 dark:text-gray-200">
                        <div className="w-1.5 h-1.5 bg-[#D01B17] rounded-full flex-shrink-0"></div>
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full bg-[#D01B17] hover:bg-[#D01B17] text-white py-3 flex items-center justify-center space-x-2 transition-all duration-200"
                >
            ...
            <div className="bg-gray-100 dark:bg-[#23272F] p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-center space-x-2 text-xs text-gray-700 dark:text-gray-200">
                <div className="w-2 h-2 bg-[#D01B17] rounded-full animate-pulse"></div>
                <span>{t('status')}</span>
              </div>
            </div>
          </div>
