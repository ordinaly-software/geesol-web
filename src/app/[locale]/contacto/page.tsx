        ...
        <div className="mx-auto max-w-6xl rounded-[28px] bg-[#f7f8fb] p-8 shadow-[0_16px_45px_rgba(12,59,82,0.12)] dark:bg-[#0f172a] dark:shadow-[0_16px_45px_rgba(0,0,0,0.35)]">
          <div className="grid gap-6 lg:grid-cols-[0.6fr_1fr]">
            ...
            <div className="relative h-80 overflow-hidden rounded-[24px] bg-gradient-to-br from-[#0c3b52] to-[#c83c3e]">
              <div className="absolute inset-0 flex items-center justify-center text-center text-white opacity-80">
                <div>
                  <div className="text-sm uppercase tracking-[0.2em]">Mapa</div>
                  <div className="text-2xl font-black">Mapa pendiente</div>
                  <div className="mt-2 text-sm">Inserta aquí tu iframe de Google Maps o OpenStreetMap.</div>
                </div>
              </div>
            </div>
          </div>
