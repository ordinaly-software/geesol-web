...
const testimonials = [
  {
    name: "Yolanda",
    quote:
      "Una instalación rápida y un equipo que explicó cada paso. Ahora pago mucho menos en la factura.",
    rating: 5,
  },
  {
    name: "Jessica Aguilar",
    quote:
      "Se encargaron de todo el papeleo y las subvenciones. El ahorro se nota desde el primer mes.",
    rating: 5,
  },
  {
    name: "Luis Javier Amor",
    quote:
      "Profesionales, puntuales y con una atención posventa impecable. Los recomiendo.",
    rating: 5,
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 text-center">
          <h3 className="text-2xl font-bold text-[#0c3b52] dark:text-white">
            La satisfacción de nuestros clientes, nuestro mejor aval
          </h3>
        </div>
        <div className="grid gap-6 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div
              ...
              className="rounded-[28px] bg-white p-6 shadow-[0_14px_42px_rgba(12,59,82,0.12)] dark:bg-[#0b1220] dark:shadow-[0_14px_42px_rgba(0,0,0,0.35)]"
            >
              <div className="mb-3 text-[#c81618]">
                {"★".repeat(testimonial.rating)}
              </div>
              <p className="mb-4 text-gray-700 dark:text-gray-300">
                {testimonial.quote}
              </p>
              <div className="text-sm font-semibold text-[#0c3b52] dark:text-white">
                {testimonial.name}
              </div>
            </div>
          ))}
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          Puedes ver más reseñas y vídeos de testimonios reales de nuestros
